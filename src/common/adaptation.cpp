...
constexpr std::array<VideoProfile, 9> kProfiles{{
    ...
    {1, 900, 30, 640, 360, 10, 4, 0.50, 0.75, false},
    {2, 700, 30, 640, 360, 8, 4, 0.75, 1.00, false},
    {3, 500, 30, 512, 288, 6, 3, 1.00, 2.00, false},
    {4, 350, 30, 320, 180, 1, 1, 3.00, 4.00, true},
    {5, 300, 30, 320, 180, 1, 1, 5.00, 6.00, true},
    {6, 260, 28, 320, 180, 1, 1, 7.00, 8.00, true},
    {7, 240, 26, 320, 180, 1, 1, 10.00, 10.00, true},
    {8, 220, 24, 320, 180, 1, 1, 12.00, 12.00, true},
}};
