...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v1.5.5"
  WORKING_DIRECTORY "D:/Code/C++/SRT-Weak-Network-Video/build-clean/_deps/srt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Code/C++/SRT-Weak-Network-Video/build-clean/_deps/srt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Code/C++/SRT-Weak-Network-Video/build-clean/_deps/srt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
